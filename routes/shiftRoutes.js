...
const { createShift, editShift, deleteShift, getShiftsByUser, getShiftsByWeek } = require('../controllers/shifts');
const { authorizeToken, isAdmin } = require('../middlewares');

router.get('/shifts/:shift_start/:shift_end', authorizeToken, isAdmin, getShiftsByWeek);
